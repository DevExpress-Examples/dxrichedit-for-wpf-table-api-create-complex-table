...
Namespace Walkthrough_Creating_Table
    ...
    Public Partial Class MainWindow
        ...
        Private Sub CreateTable()
            Dim doc As Document = Me.richEditControl1.Document
            ' Clear out the document content
            doc.Delete(Me.richEditControl1.Document.Range)
        ...
        Private Sub CreateStyles()
            ' Define basic style
            Dim tStyleNormal As TableStyle = Me.richEditControl1.Document.TableStyles.CreateNew()
            ...
            Me.richEditControl1.Document.TableStyles.Add(tStyleNormal)
            ' Define Grid Eight style
            Dim tStyleGrid8 As TableStyle = Me.richEditControl1.Document.TableStyles.CreateNew()
            ...
            Me.richEditControl1.Document.TableStyles.Add(tStyleGrid8)
            ' Define Headings paragraph style
            Dim pStyleHeadings As ParagraphStyle = Me.richEditControl1.Document.ParagraphStyles.CreateNew()
            pStyleHeadings.Bold = True
            pStyleHeadings.ForeColor = Color.White
            pStyleHeadings.Name = "My Headings Style"
            Me.richEditControl1.Document.ParagraphStyles.Add(pStyleHeadings)
        End Sub
