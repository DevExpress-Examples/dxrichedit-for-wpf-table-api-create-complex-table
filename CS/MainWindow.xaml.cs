...
namespace dxrichedit_table
{
    ...
    public partial class MainWindow : ThemedWindow
    {
        ...
        private void InsertButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        private void MergeButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
        ...
        private void ContentButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            // Insert header data
        ...
        private void ContentFormatButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        private void AppearanceButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        private void CustomizeButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
            ...
            private void DeleteCellButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
        ...
        private void DeleteRowButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
        ...
        private void DeleteColumnButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
        ...
        private void RepeatButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
        ...
        private void PositionButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
        ...
        private void RotateButtonItem_ItemClick(object sender, ItemClickEventArgs e)
        {
            table.BeginUpdate();
